...
//And the word with which it is to be replaced.It replaces the first instance of the word.

public class Replace_First extends Editor
{
	public Replace_First()
	{
		...
		if(Word_To_Replace!=null)
                {
                    ...
                    if(Word_To_Replace_With!=null)
                    {
                        ...
                        String str=text_in_editor.replaceFirst(Word_To_Replace,Word_To_Replace_With);
                        Text_In_Editor=new StringBuilder(str);
                        Panel_To_Type.setText(str);
                        if(text_in_editor.equals(str) &&(Word_To_Replace.length()!=0))
